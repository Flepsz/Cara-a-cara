...
class CaraACara:
    def __init__(self):
        self.__palavras = {
            ...
            "Barack Obama": ["Ex-presidente dos EUA", "Nobel da Paz", "Autor de livros", "Advogado", "Foi professor de direito"],
            ...
            "David Beckham": ["Jogador de futebol", "Modelo", "Embaixador da UNICEF", "Empresário", "Marido de Victoria Beckham"],
            ...
            "Neymar Jr": ["Jogador de futebol", "Começou a carreira no Santos", "Atualmente joga no Paris Saint-Germain", "Conhecido por suas habilidades e dribles", "Já venceu a Liga dos Campeões da UEFA"],
            ...
            "Fernanda Montenegro": ["Atriz", "Nasceu em Rio de Janeiro - RJ", "Trabalhou em diversas produções de TV, cinema e teatro", "Já foi indicada ao Oscar de Melhor Atriz por Central do Brasil", "Considerada uma das maiores atrizes brasileiras"],
